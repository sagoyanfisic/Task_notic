...
****************/
mysql_connect('127.0.0.1', 'root', 'root') or trigger_error("Unable to connect to the database: " . mysql_error());
mysql_select_db('angularcore') or trigger_error("Unable to switch to the database: " . mysql_error());
